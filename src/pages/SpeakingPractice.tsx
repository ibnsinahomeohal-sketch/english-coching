...
export default function SpeakingPractice() {
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: 'rgba(21, 10, 10, 0.06)' }}>
      <PageHero 
        title="Speaking Practice"
        subtitle="Practice your English speaking skills"
        icon={Mic}
        darkColor="#150a0a"
        badge="Speaking"
        pattern={
          <svg width="100%" height="100%" viewBox="0 0 100 100" preserveAspectRatio="none">
            <pattern id="waves" width="20" height="20" patternUnits="userSpaceOnUse">
              <path d="M 0 10 Q 5 5 10 10 T 20 10" fill="none" stroke="#991b1b" strokeWidth="1" />
            </pattern>
