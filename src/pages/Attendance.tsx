...
import { ScanLine, CheckCircle, X, MessageCircle, UserX, UserCheck, Smartphone, Camera, AlertTriangle, Clock, Loader2 } from "lucide-react";
...
export default function Attendance() {
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: 'rgba(7, 26, 19, 0.06)' }}>
      <PageHero 
        title="Daily Attendance"
        subtitle="Scan QR code or enter Student ID manually to mark attendance"
        icon={ScanLine}
        darkColor="#071a13"
        badge="Attendance"
        pattern={
          <svg width="100%" height="100%" viewBox="0 0 100 100" preserveAspectRatio="none">
            <pattern id="check" width="20" height="20" patternUnits="userSpaceOnUse">
              <path d="M5 10 L8 13 L15 6" fill="none" stroke="#059669" strokeWidth="2" />
            </pattern>
